...
static const yytype_uint8 yyprhs[] =
{
     ...
     195,   200,   201,   206,   209,   213,   214,   219,   222,   225
};
...
#line 453 "Bison_Rule.y"
    {
                    ...
                    g=ProgramNode((yyvsp[(1) - (4)].string),"TOKEN_LB",g);
...
#line 787 "Bison_Rule.y"
    {
              ...
              ProgramNode((yyvsp[(1) - (2)].string), "TOKEN_ASSIGNOP", c);
              ProgramNode((yyvsp[(2) - (2)].node), c);
              (yyval.node) = c;
                  ;}
    break;
...
#line 795 "Bison_Rule.y"
    {
                tnode *d = CreateTnode();
    					  ...
    					  ProgramNode((yyvsp[(1) - (4)].string), "TOKEN_ID",d);
    					  ProgramNode((yyvsp[(2) - (4)].node),d);
    					  ProgramNode((yyvsp[(3) - (4)].string), "TOKEN_ASSIGNOP",d);
    					  ProgramNode((yyvsp[(4) - (4)].node),d);
    					  (yyval.node) = d;
          					;}
    break;
